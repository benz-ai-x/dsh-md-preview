...
writeFileSync('/tmp/mdpreview-0110a3-smoke-home.txt', smokeHome + '\n')
...
try {
  ...
  await stop(server)
  server = null
  writeFileSync('/tmp/mdpreview-0110a3-packed-smoke.json', JSON.stringify(result, null, 2) + '\n')
