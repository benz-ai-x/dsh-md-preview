...
const smokeHome = mkdtempSync('/tmp/mdpreview-0110a4-smoke-')
...
const result = { version, sourceCommit: 'da3d52255d42a54ef09c4ba5f794344f0d1d934b', node: process.version, pnpm: execFileSync('pnpm', ['--version'], { encoding: 'utf8' }).trim(), baseline: '0.1.5-alpha.1+737e95c657a95fd04b12269313902f9b5ca2f6ca', profile, archiveSha256: digest(readFileSync(archive)), shutdown: [] }
writeFileSync('/tmp/mdpreview-0110a4-smoke-home.txt', smokeHome + '\n')
...
try {
  ...
  await stop(server)
  server = null
  writeFileSync('/tmp/mdpreview-0110a4-packed-smoke.json', JSON.stringify(result, null, 2) + '\n')
